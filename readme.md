# Spring PetClinic Sample Application (Product Module) [![Build Status](https://travis-ci.org/sample-petclinic-product-module/spring-petclinic.svg?branch=master)](https://travis-ci.org/sample-petclinic-product-module/spring-petclinic)
